...
const endingCards: Card[] = [
  ...
  },
  {
    ...
    left: { text: 'Publicar la verdad completa', effects: {}, epilogueText: 'Se queda sin apoyos, pero al menos sin más secretos que esconder, que ya eran pocos. Fin del gobierno, tarde mejor que nunca.' },
  ...
  },
  {
    ...
    text: 'En cada asamblea local piden su cabeza, y esta vez con razón. Hasta en la del pueblo de su suegro, que ya no le coge el teléfono.',
  ...
  },
  {
    ...
    phase: 4,
    character: 'El Comité Ejecutivo',
    text: 'La gente le quiere de verdad y se lo ha ganado gobernando bien. Le llaman "el líder", a secas. En el comité ya no le miden en escaños: le miden en fieles. Y han llegado a la conclusión de que los fieles se administran mejor desde fuera del Gobierno.',
    left: { text: 'Pedirles que se dejen de tonterías y gobiernen', effects: {}, epilogueText: 'Les pide que vuelvan al Consejo de Ministros. Le contestan que el Consejo de Ministros se les ha quedado pequeño. La ejecutiva registra una fundación, llena las sedes de velas y deja tres ministerios sin cubrir. Fin del gobierno, y usted patrón de algo que no pidió.' },
    right: { text: 'Dejarles hacer lo que quieran con su cara', effects: {}, epilogueText: 'Su cara acaba en un llavero, en un mural de ocho pisos y en el salón de miles de casas. El partido ya no registra enmiendas: organiza peregrinaciones. Cuando un periodista pregunta quién está gobernando, nadie de la sala sabe contestarle. Fin del gobierno, por aclamación.' },
    isEnding: true,
  ...
  },
  {
    ...
    phase: 4,
    character: 'El Comité Ejecutivo',
    text: 'Su popularidad ya no roza lo religioso: lo es. Le paran por la calle, le abrazan, le acercan a los niños. En el partido llevan meses haciendo cuentas y les sale siempre lo mismo: sin usted no son nada, y con usted tampoco son un partido.',
    left: { text: 'Repartir el protagonismo entre todos', effects: {}, epilogueText: 'Intenta compartir cartel y descubre que ya no hay cartel que compartir: a los actos sin usted no va nadie. La ejecutiva convierte las agrupaciones en centros de encuentro y deja de presentar candidatos. Fin del gobierno, por falta de partido.' },
    right: { text: 'Quedarse con todo el foco', effects: {}, epilogueText: 'Dejan de convocarse congresos y empiezan a convocarse concentraciones. Nadie discute una ponencia porque ya no hay ponencias. El día que había que aprobar los presupuestos no aparece ni un diputado: están todos en una vigilia. Fin del gobierno, por exceso de fe.' },
    isEnding: true,
  ...
  },
  {
    ...
    phase: 4,
    character: 'El Comité Ejecutivo',
    text: 'Le aclaman como a un mesías y buena parte de eso lo fabricó usted: encuestas cocinadas, bots y medios afines. Da igual cómo se construyó, porque el cariño ya es real. Y en el comité han decidido que un cariño así no se gestiona con un programa electoral.',
    left: { text: 'Desmontar el tinglado usted mismo', effects: {}, epilogueText: 'Confiesa el montaje entero en rueda de prensa. No le cree nadie: leen la confesión como una prueba de humildad y las adhesiones se triplican esa misma tarde. El partido registra los estatutos de algo que ya no es un partido. Fin del gobierno, y el milagro sin desmentir.' },
    right: { text: 'Alimentar el culto un poco más', effects: {}, epilogueText: 'Lo que empezó con cuatro bots termina con gente haciendo cola de madrugada para verle pasar en coche. El partido despide al jefe de campaña y contrata a un maestro de ceremonias. Gobernar, a estas alturas, le parece a todo el mundo un detalle menor. Fin del gobierno, por ascensión.' },
    isEnding: true,
